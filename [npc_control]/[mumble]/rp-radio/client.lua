...
Radio.Labels = {        
	{ "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " For at gemme.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ for at ~g~Start~s~.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ eller ~" .. radioConfig.Controls.Increase.Name .. "~ til at skifte kanal~n~~" .. radioConfig.Controls.Input.Name .. "~ For at skifte radio~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ for ~a~ mikrofonen~n~Kanal: ~1~" },
	{ "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " For at gemme.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ for at ~r~Sluk~s~.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ to broadcast.~n~Frequency: ~1~ MHz" },
	...
	while true do
		...
		if Radio.Open then
			...
			if not Radio.On then
				AddTextComponentSubstringPlayerName(Radio.Clicks and "~r~SLUK~w~" or "~g~TÆNDE~w~")
			end
